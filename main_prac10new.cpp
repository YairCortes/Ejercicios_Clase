/*Semestre 2019 - 2
	...
	VISUAL STUDIO 2017
	PRACTICA 10 (clase)
		SE MUESTRA UN AUTOMOVIL EN DONDE SE POSICIONO SUS LLANTAS,
		SE LES DIO ROTACION A LAS LLATAS PARA DAR EL EFECTO DE QUE AVANZA
		Y EL AUTOMOVIL AL LLEGAR AL FINAL DE LA CARRETER REGRESA EN SENTIDO CONTRARIO HASTA 
		EL OTRO EXTREMO DE LA CARRETERA.
		(PARA LA ANIMACION CON TABULADOR)
*/
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	//Carga de Figuras
	kit._3dsLoad("kitt.3ds"); //MANDAR A LLAMAR MODELO 3D	
	//kit.VertexNormals(); 
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(0, 4, movKit); //ANIMACION DEL VEHICULO
...
void animacion()
{
	...
	//SE APLICA LA REVERSA CAMBIANDO TAMBIEN LA ROTACION DE LAS LLANTAS
