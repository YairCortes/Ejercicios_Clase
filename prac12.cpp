...
VISUAL STUDIO 2017
PRACTICA 12(Clase)
		AUTO CON MOVIMIENTO SIGUIENDO UNA TRAYECTORIA EN DIAGONAL.
		I-i PARA ANIMACION
*/
...
void animacion()
{
	...
	if(circuito) //COMIENZA MAQ. DE ESTADOS
	{
		...
		{
			rotKit = -140; //rotamos el carro
			movKitZ -= 2.0; //diagonal 
			movKitX -= 0.8;
			if(movKitX<=0) //Cambiamos al sig estado de la Diagonal
			{
				recorrido3 = false;
				recorrido5 = true;
			}
